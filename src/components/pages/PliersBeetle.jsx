...
import LocalBeetleImg4 from "../../assets/PliersBeetle/ด้วงคีมสายรุ้ง1.jpg";
import LocalBeetleImg5 from "../../assets/PliersBeetle/ด้วงคีมสายรุ้ง2.jpg";
...
const products = [
  {
    ...
    description: "ด้วงคีมเนื้อทรายเชียงใหม่:ตัวอ่อน:L1–2: 1 ตัว",
    tags: ["wf1", "37xff"],
  },
  {
    id: 2,
    ...
    description: "ด้วงคีมฟันเลื่อยเหนือ:ตัวอ่อน:L1–2: 1 ตัว:พร้อมก้อนเชื้อเห็",
    tags: ["wf1", "76xff"],
  },
  {
    id: 3,
    ...
    description: "ด้วงคีมสายรุ้งสีแดงตัวเพาะไต้หวัน:ตัวอ่อน:L1–2: 1 ตัว",
    tags: ["ตัวเพาะ", "55xff"],
  },
  {
    id: 4,
    ...
    description:
      "ด้วงคีมสายรุ้งสีแดงตัวเพาะไต้หวันxผู้บ่าวขายด้วง:ตัวอ่อน:L1–2: 1 ตัว",
    tags: ["CBF1", "55xff"],
  },
  {
    id: 5,
    ...
    description:
      "ด้วงคีมสายรุ้งสีแดงตัวเพาะไต้หวันxผู้บ่าวขายด้วง(normal):ตัวอ่อน:L1–2: 1 ตัว",
    tags: ["CBF1", "55xff"],
  },
  {
    id: 6,
    ...
    description: "ด้วงคีมแลมพลีม่าตัวเพาะญี่ปุ่น:ตัวอ่อน:L1–2: 1 ตัว",
    tags: ["CBF1", "คุ้มค่า"],
  },
  {
    id: 7,
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-600 dark:text-gray-300">
                  ค่าส่งคิดต่อออเดอร์ (เลือกได้ตลอด)
                </p>
              </div>
            </div>
...
export default function Beetle() {
  const [shipping, setShipping] = useLocalStorage("shipping_choice", "flash");

  return (
    <div style={{ minHeight: "100vh", padding: "20px" }}>
      <AnimatedNatureBackground />

      {/* Dock เลือกค่าส่ง (ติดขอบล่าง) */}
